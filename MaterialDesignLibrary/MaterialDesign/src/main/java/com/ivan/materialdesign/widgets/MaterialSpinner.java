package com.ivan.materialdesign.widgets;
...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    */
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        backgroundHint = Color.TRANSPARENT;
    ...
    */
    ...
    public int getBackgroundHint()
    {
        return backgroundHint;
    }

    public void setBackgroundHint(int backgroundHint){
    ...
    public class HintAdapter extends BaseAdapter {
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            textView.setVisibility(isDropDownView ? GONE : VISIBLE);
            final int height = isDropDownView ? 1 : RelativeLayout.LayoutParams.WRAP_CONTENT;
            textView.getLayoutParams().height = height;
            textView.setText(hint);
            textView.setTextColor(MaterialSpinner.this.isEnabled() ? hintColor : disabledColor);
            final int back = isDropDownView ? backgroundHint : Color.TRANSPARENT;
