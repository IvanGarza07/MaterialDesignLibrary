...
import com.ivan.materialdesign.views.ButtonFloatSmall;
import com.ivan.materialdesign.views.LayoutRipple;
import com.ivan.materialdesign.widgets.ColorSelector;
import com.ivan.materialdesign.widgets.ColorSelector.OnColorSelectedListener;
import com.ivan.materialdesign.widgets.MaterialSpinner;
...
public class MainActivity extends Activity implements OnColorSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		layoutRipple = (LayoutRipple) findViewById(R.id.itemSpinner);
		...
		layoutRipple.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View arg0) {
				Intent intent = new Intent(MainActivity.this,MaterialSpinnerActivity.class);
				intent.putExtra("BACKGROUND", backgroundColor);
				startActivity(intent);
			}
		});
		layoutRipple = (LayoutRipple) findViewById(R.id.itemEditText);
